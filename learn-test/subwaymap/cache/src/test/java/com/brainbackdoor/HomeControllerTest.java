...
class HomeControllerTest {
    ...
    void testCompression() {
        ...
        log.info("headers: {}", response.getResponseHeaders());
        log.info("response body\n{}", response.getResponseBody());
    }
    ...
    void testCacheBustingOfStaticResources() {
        ...
        final var finalResponse = webTestClient
                .get()
                .uri(uri)
        ...
        log.info("headers: {}, status code: {}", finalResponse.getResponseHeaders(), finalResponse.getStatus());
    }
}